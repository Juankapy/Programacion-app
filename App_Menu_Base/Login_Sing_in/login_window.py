...
from App_Menu_Base.menu import MainWindow  # Importar la clase de tu ventana principal

class LoginWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi("Login_Sing_in/login.ui", self)  # Ruta corregida para cargar el archivo UI
        ...
        self.bt_restaurar.setIcon(QIcon("Login_Sing_in/image/new-tab.png"))
        self.bt_minimizar.setIcon(QIcon("Login_Sing_in/image/minimize.png"))
        self.bt_maximizar.setIcon(QIcon("Login_Sing_in/image/maximize.png"))
        self.bt_cerrar.setIcon(QIcon("Login_Sing_in/image/cancel.png"))
    ...
    def open_menu_window(self):
        ...
        """
        self.menu_window = MainWindow()  # Crea una instancia de la ventana principal
    ...
    def show_message(self, title, message, icon):
        ...
        msg_box.setWindowTitle(title)  # Establece el título del cuadro
        msg_box.setText(message)  # Establece el texto del mensaje
        msg_box.setIcon(icon)  # Establece el ícono del mensaje
        msg_box.exec()  # Muestra el cuadro de mensaje
