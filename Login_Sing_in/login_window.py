...
from App_Menu_Base.menu import MenuWindow
from Login_Sing_in.auth import login
from App_Menu_Base.Base import fetch_all_data
...
class LoginWindow(QMainWindow):
    ...
    def handle_login(self):
        ...
        # Depuración: imprime los valores de username y password
        ...
        try:
            ...
            print(f"Excepción inesperada: {str(e)}")  # Imprimir en consola
    ...
    def show_error_message(self, message):
        ...
        """
        self.lb_error.setText("Buen error maquina")  # Establece el texto del mensaje de error
    ...
    def open_menu_window(self):
        ...
        """
        self.menu_window = MenuWindow()  # Crea una instancia de la ventana del menú
